...
import com.thl.stocktaking.utils.camera.CameraManager;
import com.thl.stocktaking.widget.ViewfinderView;

import java.io.IOException;
import java.util.Collection;
import java.util.Map;

//import com.hzwy.apps.hotelapp.constants.BitmapUtils;
 ...
 * @author jayqiu
 */
abstract class CaptureActivity extends BaseActivity implements SurfaceHolder.Callback,
        View.OnClickListener, View.OnTouchListener, Camera.PreviewCallback{

    private static final String TAG = CaptureActivity.class.getSimpleName();
    
    protected  Handler handler;
    protected int threadNum = 0;//帧图片处理线程数量

    protected  int CAMERA_FACING;
...
//    }
    ...
    protected void onResume() {
        ...
        // 会导致扫描窗口的尺寸计算有误的bug
        cameraManager = new CameraManager(CaptureActivity.this,this);
...
//        SurfaceView surfaceView = (SurfaceView) findViewById(R.id.cameraWidgetId); // 预览
...
//    }
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        try {
            cameraManager.openDriver(surfaceHolder,CAMERA_FACING);
...
//            cameraManager.requestPreviewFrame(null,0);
...
//    public  abstract  void  onAlbumDecode(String resultString,int status);
    ...
    protected void sendNotify(int what, String info, float value) {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        cameraManager.touchFocus(v,event);
        return false;
    }
}
