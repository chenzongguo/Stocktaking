package com.thl.stocktaking.faceserver;
...
import com.thl.stocktaking.model.FaceRegisterInfo;
import com.thl.stocktaking.utils.ImageUtils;
                        ...
                        if (bitmap != null) {
                            switch (faceInfoList.get(0).getOrient()) {
                                ...
                                case FaceEngine.ASF_OC_90:
                                    bitmap = ImageUtils.getRotateBitmap(bitmap, 90);
                                    needAdjust = true;
                                    break;
                                ...
                                case FaceEngine.ASF_OC_270:
                                    bitmap = ImageUtils.getRotateBitmap(bitmap, 270);
                                    needAdjust = true;
                                    break;
                                default:
                                    break;
